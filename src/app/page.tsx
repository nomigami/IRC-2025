        ...
        <footer className="bg-black text-white py-6 mt-12">
          <div className="max-w-6xl mx-auto px-6 flex flex-col items-center gap-6">
            ...
            <div className="flex gap-6">
              <a href="https://instagram.com/innovation_robotic_competition" target="_blank" rel="noreferrer">
                <img src="/INS.png" alt="instagram" className="w-7 h-7 hover:scale-110 transition-transform" />
              </a>
              <a href="https://www.instagram.com/sentral_robotik?igsh=ZWM0ajNjMjYxZTFm" target="_blank" rel="noreferrer">
                <img src="/INS.png" alt="instagram" className="w-7 h-7 hover:scale-110 transition-transform" />
              </a>
            </div>
